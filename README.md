...
> Only **296 MB** after installed.

```sh
docker images | grep thiagobraga/php8.0-fpm-mongodb-alpine3.13
# thiagobraga/php8.0-fpm-mongodb-alpine3.13  latest  1a0bb8aae60b  296MB
```
